      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:100%;background:${BRAND.white};border-radius:20px;overflow:hidden;box-shadow:0 8px 30px rgba(20,20,60,0.08);">
        ...
        ${
          ...
          <td style="padding:24px 40px 36px;">
            <div style="font-family:${FONT};font-size:14px;line-height:1.5;color:${BRAND.text};background:${BRAND.soft};border:1px solid ${BRAND.border};border-radius:12px;padding:14px 18px;">
              <strong style="color:${BRAND.heading};">Répondez directement à cet email</strong> pour contacter ${escapeHtml(firstname || fullName || "ce contact")} — votre réponse lui sera adressée automatiquement.
            </div>
          </td>
        </tr>`
            : ""
